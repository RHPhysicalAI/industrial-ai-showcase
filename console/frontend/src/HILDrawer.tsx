              ...
              <Card>
                ...
                <CardBody>
                  <Stack hasGutter>
                    ...
                    <StackItem>
                      <strong>Impact:</strong> <Label color={
                        (approval.blast_radius?.impact_level ?? "low") === "high" ? "red" :
                        (approval.blast_radius?.impact_level ?? "low") === "medium" ? "orange" : "green"
                      }>{(approval.blast_radius?.impact_level ?? "low").toUpperCase()}</Label>
                    </StackItem>
                    <StackItem>
